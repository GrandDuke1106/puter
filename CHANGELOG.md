...
* add 'path' option to showOpenFileDialog ([47e2e8e](https://github.com/GrandDuke1106/puter/commit/47e2e8ee785fd72a7f5ded51825eb0d3a082e406))
* add copy mode save ([6b0865e](https://github.com/GrandDuke1106/puter/commit/6b0865e2841934385111709331c86ed4716f585d))
* **aws/polly:** add new apis to puter-js, add new args to txt2speech ([#1337](https://github.com/GrandDuke1106/puter/issues/1337)) ([0b6dbe5](https://github.com/GrandDuke1106/puter/commit/0b6dbe587a943f3b283be382fc12690034ec26c0))
* **gui:** Add animation effects to the taskbar ([#1365](https://github.com/GrandDuke1106/puter/issues/1365)) ([212bc88](https://github.com/GrandDuke1106/puter/commit/212bc88c8f7561a7b1dc9bac3d5308ec2275c8e1))
* implement authentication UI in Puter.js's test UI ([3def1d4](https://github.com/GrandDuke1106/puter/commit/3def1d4d7c03f784f26edbb802f2478aa16f0eea))
* implement settings management and modal in puter.js test framework ([9ca1f06](https://github.com/GrandDuke1106/puter/commit/9ca1f0639a92a0ea5ce43081a4f43e33b02dc08f))
* improve 404 error handling in Puter sites with custom page support ([#1466](https://github.com/GrandDuke1106/puter/issues/1466)) ([4c3a68e](https://github.com/GrandDuke1106/puter/commit/4c3a68ee51a1b255edbe6b3c7e4c4e3b0394dae3))
* make it possible to pass signed files to launchApp ([5522cfb](https://github.com/GrandDuke1106/puter/commit/5522cfbd52576205c78f5e7db8383b4695ab61f4))
* memory filesystem provider ([a98cc45](https://github.com/GrandDuke1106/puter/commit/a98cc45f22c18549026c6586f92dcf1510a00687))
* puter workers ([bddc872](https://github.com/GrandDuke1106/puter/commit/bddc872e009abecffc8517a55d5222025fc113e7))
* update Norwegian Nynorsk (nn.js) translations ([#1463](https://github.com/GrandDuke1106/puter/issues/1463)) ([090d1af](https://github.com/GrandDuke1106/puter/commit/090d1afa9c6ef2606c9e83f2685b123086a1e853)), closes [#366](https://github.com/GrandDuke1106/puter/issues/366)


### Bug Fixes

* (for node 18) import parse-domain as esmodule ([1a9ff9e](https://github.com/GrandDuke1106/puter/commit/1a9ff9e954075075683e105d5d0f0d0d45c77db5))
* 1231 ([9a84776](https://github.com/GrandDuke1106/puter/commit/9a847760bceefcd13f174bebfdc1ecd5708fa5be))
* add .undefinedOnCancel to showSaveFilePicker ([e8d6381](https://github.com/GrandDuke1106/puter/commit/e8d63819a8f31976ad29bf6dcb295a37486eb06a))
* add missing unit conversion step ([4b5955b](https://github.com/GrandDuke1106/puter/commit/4b5955b45963711bc5d19b0f242971b39be1b058))
* add necessary supporting code for funding update ([1c19086](https://github.com/GrandDuke1106/puter/commit/1c1908659262ff1ae7a89191b5adc6c025bd5e98))
* add one I missed previous commit ([5b7b524](https://github.com/GrandDuke1106/puter/commit/5b7b52408003c173ec21aa74f5eb756ecf8d77cd))
* add safeguard in case server response is wrong ([cbfb928](https://github.com/GrandDuke1106/puter/commit/cbfb9283d10f248976d28f8ab55b5d1c83ca1980))
* add support for new Endpoint usage ([db960d5](https://github.com/GrandDuke1106/puter/commit/db960d585a244716e683ac726b25c5e3aba57f95))
* allow paths like %appdata%/subdir ([0180592](https://github.com/GrandDuke1106/puter/commit/018059258b16e5e7220e4b96c743a519bec7358f))
* APIErrors in entri service ([ba2609b](https://github.com/GrandDuke1106/puter/commit/ba2609be28bdb8175f302d7d82b7443a3d9d0070))
* arrow key navigation ([ae07a5e](https://github.com/GrandDuke1106/puter/commit/ae07a5e316a16cfff281c25f9b4674f24fe93b65))
* arrow keys unresponsive when selecting items with offset center points ([5fd5017](https://github.com/GrandDuke1106/puter/commit/5fd50170801813e29e6c309d0f4e840cf7506eef))
* complete Norwegian Nynorsk translation ([807d7bd](https://github.com/GrandDuke1106/puter/commit/807d7bd698a75f011cbbb1df1de3322701088727))
* confirm email with code flow ([7b1fb5d](https://github.com/GrandDuke1106/puter/commit/7b1fb5d9a6ce9998c9eed0c4a7f37249cd3d844c))
* cost testing model ([f46d47d](https://github.com/GrandDuke1106/puter/commit/f46d47d2a8fefee01f1b5570018a6b5c4144e83d))
* dav: Allow macOS x-epected-entity-length ([439f5fa](https://github.com/GrandDuke1106/puter/commit/439f5fa8503a6d00900dc72e5a824d72148a4792))
* **desktop:** prevent horizontal scrolling by constraining window drag [#710](https://github.com/GrandDuke1106/puter/issues/710) ([#1443](https://github.com/GrandDuke1106/puter/issues/1443)) ([c93c296](https://github.com/GrandDuke1106/puter/commit/c93c2965d25d4efd39fa3092d3680968ee7f39cb))
* Diswhitelist credential sharing for CORS ([a08948f](https://github.com/GrandDuke1106/puter/commit/a08948f90526b2e0a1d733b6c939fcad3dc157d2))
* don't encrypt session UUID if there isn't one ([d4250d6](https://github.com/GrandDuke1106/puter/commit/d4250d65aa16ff8dd7eb81097c5c0c248b5efd55))
* enable and fix date command tests ([d885ea5](https://github.com/GrandDuke1106/puter/commit/d885ea5772b9aab6dce3092139309df79753d701)), closes [#796](https://github.com/GrandDuke1106/puter/issues/796)
* file cleanup for Claude when streaming ([50d520f](https://github.com/GrandDuke1106/puter/commit/50d520f09935f34bad6420ec8c8373ba2ed7e13c))
* get sharp far away from bundlers as possible ([963b248](https://github.com/GrandDuke1106/puter/commit/963b248582a8d2aec67261ca171d48076575b84d))
* **gui:** prevent background apps from stealing focus ([#1491](https://github.com/GrandDuke1106/puter/issues/1491)) ([cddfa0c](https://github.com/GrandDuke1106/puter/commit/cddfa0ca1152423078c163e483570075f0ed3845))
* hoist resetTurnstile ([481b18b](https://github.com/GrandDuke1106/puter/commit/481b18b2281fc623465e836c6aa2c90447c282dc))
* improve support for unbounded range headers ([e48179a](https://github.com/GrandDuke1106/puter/commit/e48179a1f992eef4551474f69778508fe92d3ce3))
* improvements to jaeger trace service ([fd956cb](https://github.com/GrandDuke1106/puter/commit/fd956cb1cd23d28b935c3693c29c10208845261f))
* include base reserved words by default ([c7970fd](https://github.com/GrandDuke1106/puter/commit/c7970fd1a830dfcbe0e031007bceafeb97bb8084))
* incorrect call to APIError from configurable_auth ([5903f1f](https://github.com/GrandDuke1106/puter/commit/5903f1fb31eb1cbbcb0d346ebefc716c9d6e68ad))
* incorrect pricing ([ae4dc23](https://github.com/GrandDuke1106/puter/commit/ae4dc23c378c624bd6aa76bd45d201d476445a25))
* install ([2d9526b](https://github.com/GrandDuke1106/puter/commit/2d9526ba404bead5beaa87c86712dee4984b28dc))
* issue cancelling replace during save by move ([4a996c5](https://github.com/GrandDuke1106/puter/commit/4a996c556ab5983e42886c283d2bdeda06ee03c5))
* issue using ll_write outside of hl_write ([152a557](https://github.com/GrandDuke1106/puter/commit/152a5578fce30dff0c183db81b52fc8332947a52))
* less copying of service configs ([43232cc](https://github.com/GrandDuke1106/puter/commit/43232ccc32821e2b88c30f42effa67f60a4423bb))
* make sharp optional ([354b116](https://github.com/GrandDuke1106/puter/commit/354b116b424243fac989009612b0e457d0e54e8c))
* Microsoft office Bearer issue ([#1461](https://github.com/GrandDuke1106/puter/issues/1461)) ([6412617](https://github.com/GrandDuke1106/puter/commit/64126179cc3134a2e1bb558eca0bf062a836d037))
* move temp users to 'user' group when email is confirmed ([4ba2f97](https://github.com/GrandDuke1106/puter/commit/4ba2f97da0654f804a67fdfbf104ad05cb7bc63a))
* necessary updates happen for move save too ([6598798](https://github.com/GrandDuke1106/puter/commit/659879812dcf77578103e58d8b9f667c91a8c589))
* objutil ([aebc758](https://github.com/GrandDuke1106/puter/commit/aebc758cbf7635441d928be749494c4b3c8480dc))
* pass dedupe_name to mkshortcut via batch ([cecc9f2](https://github.com/GrandDuke1106/puter/commit/cecc9f23dca4f07b289355d74b60db626871c931))
* possible missing path properties in /sign ([d1b4458](https://github.com/GrandDuke1106/puter/commit/d1b4458c74066b7f488d59cfb615f03fd16c562e))
* prevent entity mutation during upsert ([f2a29d5](https://github.com/GrandDuke1106/puter/commit/f2a29d5228fd18a9a71a3dbd6ca67bb42750c86f))
* prevent health check from surpressing traces ([2cd5b3c](https://github.com/GrandDuke1106/puter/commit/2cd5b3cb498ca5511b0120b4a007512837e1558f))
* properly update owner object in FSNodeContext ([d17b466](https://github.com/GrandDuke1106/puter/commit/d17b466e37eb153bfd0ec3256ed040d0fa4e5291))
* puter workers url 🐛  ([#1480](https://github.com/GrandDuke1106/puter/issues/1480)) ([6284592](https://github.com/GrandDuke1106/puter/commit/628459209ca0d394f58bc4b7cef3c167892c35fe))
* remaining issues with fake-chat/costly ([7f6b302](https://github.com/GrandDuke1106/puter/commit/7f6b3026364b6c4dee8e622aaeec1d039e3ac054))
* remove dormant condition operand from signup.js ([a7d1bf0](https://github.com/GrandDuke1106/puter/commit/a7d1bf0e99931f5dda5ec5ed0b3e894b54c82e0d))
* remove unnecessary scrollbar from Account page ([#1307](https://github.com/GrandDuke1106/puter/issues/1307))fix: remove unnecessary scrollbar from Account page ([#1307](https://github.com/GrandDuke1106/puter/issues/1307))Fix account scrollbar issue by changing overflow:hidden to overflow:v… ([#1465](https://github.com/GrandDuke1106/puter/issues/1465)) ([607b555](https://github.com/GrandDuke1106/puter/commit/607b555961f73b1efe49e2cccec42c87ab836ba9))
* return "null" for file_path and file_uid if backing file is nonexistent ([7d4ee75](https://github.com/GrandDuke1106/puter/commit/7d4ee756190b4beac8aba099e696c895d7c77a4f))
* return proper error message when the model is not found ([#1331](https://github.com/GrandDuke1106/puter/issues/1331)) ([ade213b](https://github.com/GrandDuke1106/puter/commit/ade213b88b82d44139c54ed55992745379d78548)), closes [#1326](https://github.com/GrandDuke1106/puter/issues/1326)
* save_account lock timeout ([ccdb678](https://github.com/GrandDuke1106/puter/commit/ccdb678937b9742e30061ae39fb7c710389f720c))
* shortcut KV permissions ([f6e6e8d](https://github.com/GrandDuke1106/puter/commit/f6e6e8dff829eb86a4bfa7129f01e4c0b18517db))
* sometimes WebServer log doesn't have context ([915bcf5](https://github.com/GrandDuke1106/puter/commit/915bcf5f07a9d4e651e16beda11280b708ffe038))
* streaming in FakeChatService ([2e90e8d](https://github.com/GrandDuke1106/puter/commit/2e90e8dc960fb18abe3f2120a78df3ddc9085093))
* update package-lock.json ([60a9be1](https://github.com/GrandDuke1106/puter/commit/60a9be12badd168446bd8a416cc67dd2c50487a8))
* update refresh_actor cache invalidation ([405564f](https://github.com/GrandDuke1106/puter/commit/405564f55fb9ba3b3bcac67774b12d16a69e9724))
* Use APIErrror.create in place of newAPIError ([ecff560](https://github.com/GrandDuke1106/puter/commit/ecff560480f5922cda8dafc91a3e66084a99f6e6))
* use correct API error in entri-service ([7e0b8c6](https://github.com/GrandDuke1106/puter/commit/7e0b8c66c40a0b99e4d5cb686a022f9eeaf19173))
* use correct path for openrouter max tokens ([3f5de6d](https://github.com/GrandDuke1106/puter/commit/3f5de6d493f7de34e1f2b7924c29d36f97dd14e8))
* various AI fixes ([4312280](https://github.com/GrandDuke1106/puter/commit/43122801bf9dc207843e95fa2f881ff212763b36))
* webdav MOVE/COPY escaping bug ([72e66da](https://github.com/GrandDuke1106/puter/commit/72e66da8a12e79a503c01ae64829ddf08cf32019))
* webdav service name for undefined origin ([a27f4b6](https://github.com/GrandDuke1106/puter/commit/a27f4b60e42a3fcf74c14c72433218042b9a6614))
* webdavfs class init method name init to _init ([a046f18](https://github.com/GrandDuke1106/puter/commit/a046f186d824457b87108d4cd54976a7b27419d8))
* wrong symbol in previous commit ([ca3acf1](https://github.com/GrandDuke1106/puter/commit/ca3acf13c14db089f7ce601de38f470e59988f89))
